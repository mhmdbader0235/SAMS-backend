...
@router.get(
    "/setup-state",
    response_model=SchoolSetupStateResponse,
    summary="Get the tenant's onboarding progress",
)
...
@router.get(
    ...
    summary="Get school profile, campuses, and contacts",
)
...
@router.put(
    "/profile",
    response_model=SchoolProfileResponse,
    summary="Update school identity, locale, and brand",
)
